<div class='container'>
    <div class="wrapper">
        <div class="box">
            <div class="text">
                ...
                <div>
                    Lorem ipsum dolor sitamet, consecteturadipiscing elit, sed do eiusmod tempor in-cididunt ut labore etdolore magna aliqua.
                </div>
            </div>
            <div class="likeBox">
    ...
    <div class="box" onmouseover="hover(this)" onmouseout="normal(this)">
        <div class="text">
            <div class="data" >
                DATA
            </div>
