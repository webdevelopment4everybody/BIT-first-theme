...
var days = "";
var cellId = "";
var monthDefault = ["Sausis", "Vasaris", "Kovas", "Balandis", "Gegužė", "Birželis", "Liepa", "Rugpjūtis", "Rugsėjis", "Spalis", "Lapkritis", "Gruodis"];
var dayDefault = ["S", "P", "A", "T", "K", "P", "Š"];
...
function showCalendar(month, year) {
  ...
  tbl.innerHTML = "";
  monthAndYear.innerHTML = year + " " + months[month]; // selectYear.value = year;
...
function event(cell) {
  document.getElementById('calendar-body').addEventListener('click', function (e) {
    e.target.style.backgroundColor = 'pink'; // console.log(e.target);
    axios.post('http://localhost/wordpress/wp-content/plugins/BIT-first/api/?route=event',{
      metai: e.target.getAttribute('data_year'),
      menesis: e.target.getAttribute('data_month'),
      diena: e.target.getAttribute('id'),
    })
    ...
    var HTML = ''; // takeCell[20].setAttribute("ivykis",a);
    ...
    if (e.target.getAttribute("ivykis") != null) {
      for (var i = 0; i < data.length; i++) {
        HTML += "\n            <div class=\"today-events\">\n            <h2>Siandienos ivykiai: ".concat(e.target.getAttribute("data_year"), ".").concat(e.target.getAttribute("data_month"), ".").concat(e.target.getAttribute("data_date"), "</h2> \n            <div class=\"data-time\">").concat(JSON.stringify(e.target.getAttribute("ivykis")), "</div>\n            <span></span>\n            <div class=\"event\"></div>\n            </div>\n            "); // var td = table.getElementsByTagName("td");
